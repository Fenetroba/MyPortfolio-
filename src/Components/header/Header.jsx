  ...
  return (
    <div className="Header__contener__all">
      <div className="heade__contener ">
        ...
        <p>
          welcome to my portfoli I AM <strong>MERN Stack WebDevloper</strong>
          <br />
          With Active Learning Skill.
        </p>
...
>
  ...
  <li className="icon-content">
    <a href="https://github.com/Fenetroba/" aria-label="GitHub" data-social="github" target="_blank">
      <div className="filled"></div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
